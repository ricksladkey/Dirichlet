...
<\body>
  ...
  <\equation*>
    ...
    n=1>>|<row|<cell|0>|<cell|otherwise>>>>>=\<tau\><rsub|0><around*|(|n|)>>|<cell|1>>|<row|<cell|\<lambda\><around*|(|n|)>>|<cell|<around*|(|-1|)><rsup|\<Omega\><around*|(|n|)>>>|<cell|<frac|1|1+x>>>|<row|<cell|\<lambda\><around*|(|n|)>*\<tau\><around*|(|n|)>>|<cell|<around*|(|\<lambda\>\<star\>\<lambda\>|)><around*|(|n|)>>|<cell|<frac|1|<around*|(|1+x|)><rsup|2>>>>|<row|<cell|Id<rsub|k><around*|(|n|)>>|<cell|n<rsup|k>>|<cell|<frac|1|1-p<rsup|k>*x>>>|<row|<cell|Id<rsub|0><around*|(|n|)>>|<cell|1=\<tau\><rsub|1><around*|(|n|)>>|<cell|<frac|1|1-x>>>|<row|<cell|\<sigma\><rsub|k><around*|(|n|)>>|<cell|>|<cell|<frac|1|1-<around*|(|1+p<rsup|k>|)>*x+p<rsup|k>*x<rsup|2>>>>|<row|<cell|\<tau\><rsub|k><around*|(|n|)>>|<cell|<around*|(|\<tau\><rsub|k-1>\<star\>Id<rsub|o>|)><around*|(|n|)>>|<cell|<frac|1|<around*|(|1-x|)><rsup|k>>>>|<row|<cell|\<tau\><around*|(|n|)>>|<cell|\<sigma\><rsub|0><around*|(|n|)>=\<tau\><rsub|2><around*|(|n|)>>|<cell|<frac|1|<around*|(|1-x|)><rsup|2>>>>|<row|<cell|\<mu\><rsup|2><around*|(|n|)>>|<cell|\<lambda\><rsup|-1><around*|(|n|)>>|<cell|1+x>>|<row|<cell|q<rsup|\<omega\><around*|(|n|)>>>|<cell|>|<cell|<frac|1+<around*|(|q-1|)>*x|1-x>>>|<row|<cell|q<rsup|\<Omega\><around*|(|n|)>>>|<cell|>|<cell|<frac|1|1-q*x>>>|<row|<cell|2<rsup|\<omega\><around*|(|n|)>>>|<cell|<big|sum><rsub|d<rsup|2><around*|\||n|\<nobracket\>>>\<mu\><around*|(|d|)>*\<tau\><rsub|><around*|(|<frac|n|d<rsup|2>>|)>>|<cell|<frac|1+x|1-x>>>|<row|<cell|<around*|(|-2|)><rsup|\<omega\><around*|(|n|)>>>|<cell|>|<cell|<frac|1-3x|1-x>>>|<row|<cell|\<mu\><rsup|2><around*|(|n|)>*2<rsup|\<omega\><around*|(|n|)>>>|<cell|\<mu\><rsup|2><around*|(|n|)>*\<tau\><around*|(|n|)>>|<cell|1+2*x>>|<row|<cell|3<rsup|\<omega\><around*|(|n|)>>>|<cell|>|<cell|<frac|1+2*x|1-x>>>|<row|<cell|<around*|(|-3|)><rsup|\<omega\><around*|(|n|)>>>|<cell|>|<cell|<frac|1-4*x|1-x>>>|<row|<cell|\<mu\><around*|(|n|)>*q<rsup|\<omega\><around*|(|n|)>>>|<cell|>|<cell|1-q*x>>|<row|<cell|\<mu\><rsup|2><around*|(|n|)>*q<rsup|\<omega\><around*|(|n|)>>>|<cell|>|<cell|1+q*x>>|<row|<cell|<big|sum><rsub|d<rsup|k><around*|\||n|\<nobracket\>>>\<mu\><around*|(|d|)>>|<cell|>|<cell|<frac|1-x<rsup|k>|1-x>=1+x+x<rsup|2>+\<ldots\>+x<rsup|k-1>>>|<row|<cell|<big|sum><rsub|d<rsup|2><around*|\||n|\<nobracket\>>>\<mu\><around*|(|d|)>>|<cell|\<mu\><rsup|2><around*|(|n|)>>|<cell|1+x>>|<row|<cell|<big|sum><rsub|d<rsup|3><around*|\||n|\<nobracket\>>>\<mu\><around*|(|d|)>>|<cell|>|<cell|1+x+x<rsup|2>>>|<row|<cell|\<lambda\><around*|(|n|)><big|sum><rsub|d<rsup|k><around*|\||n|\<nobracket\>>>\<mu\><around*|(|d|)>>|<cell|>|<cell|1-x+x<rsup|2>-\<ldots\>\<pm\>x<rsup|k>>>|<row|<cell|\<lambda\><around*|(|n|)>*<big|sum><rsub|d<rsup|2><around*|\||n|\<nobracket\>>>\<mu\><around*|(|d|)>>|<cell|>|<cell|1-x>>|<row|<cell|\<lambda\><around*|(|n|)>*<big|sum><rsub|d<rsup|3><around*|\||n|\<nobracket\>>>\<mu\><around*|(|d|)>>|<cell|>|<cell|1-x+x<rsup|2>>>|<row|<cell|<big|sum><rsub|d<rsup|3><around*|\||n|\<nobracket\>>>\<mu\><around*|(|d|)>*\<tau\><rsub|3><around*|(|<frac|n|d<rsup|3>>|)>>|<cell|>|<cell|<frac|1+*x+x<rsup|2>|<around*|(|1-x|)><rsup|2>>>>|<row|<cell|\<tau\><around*|(|n<rsup|2>|)>>|<cell|>|<cell|<frac|1+x|<around*|(|1-x|)><rsup|2>>>>|<row|<cell|\<tau\><rsup|2><around*|(|n|)>>|<cell|>|<cell|<frac|1+x|<around*|(|1-x|)><rsup|3>>>>>>>
  </equation*>
  ...
  <\eqnarray*>
    <tformat|<table|<row|<cell|<big|sum><rsub|n\<leq\>x/p>\<tau\><around*|(|p*n|)>>|<cell|=>|<cell|2*<big|sum><rsub|n\<leq\>x/p>\<tau\><around*|(|n|)>-<big|sum><rsub|n\<leq\>x/p<rsup|2>>\<tau\><around*|(|n|)><space|1em><around*|(|verified|)>>>|<row|<cell|>|<cell|=>|<cell|P<around*|(|x;p|)>>>|<row|<cell|<big|sum><rsub|n\<leq\>x/p>\<tau\><around*|(|p*<rsup|2>n|)>>|<cell|=>|<cell|3<big|sum><rsub|n\<leq\>x/p<rsup|2>>\<tau\><around*|(|n|)>-2*<big|sum><rsub|n\<leq\>x/p<rsup|3>>\<tau\><around*|(|n|)><space|1em><around*|(|verified|)>>>|<row|<cell|<big|sum><rsub|n\<leq\>x/p*q>\<tau\><around*|(|p*q*n|)>>|<cell|=>|<cell|2*<around*|(|<big|sum><rsub|n\<leq\>x/p>\<tau\><around*|(|n|)>+<big|sum><rsub|n\<leq\>x/q>\<tau\><around*|(|n|)>-<big|sum><rsub|n\<leq\>x/p*q>\<tau\><around*|(|n|)>|)>>>|<row|<cell|>|<cell|->|<cell|<around*|(|<big|sum><rsub|n\<leq\>x/p<rsup|2>>\<tau\><around*|(|n|)>+<big|sum><rsub|n\<leq\>x/q<rsup|2>>\<tau\><around*|(|n|)>-<big|sum><rsub|n\<leq\>x/<around*|(|p*q|)><rsup|2>>\<tau\><around*|(|n|)>|)>>>|<row|<cell|>|<cell|=>|<cell|P<around*|(|x;p|)>+P<around*|(|x;q|)>-P<around*|(|x;p*q|)>>>|<row|<cell|<big|sum><rsub|n\<leq\>x/p*q>\<tau\><around*|(|p*q*n|)>>|<cell|=>|<cell|<big|sum><rsub|n\<leq\>x,p*q<around*|\||n|\<nobracket\>>>\<tau\><around*|(|n|)>>>|<row|<cell|>|<cell|=>|<cell|<big|sum><rsub|n\<leq\>x,p*q<around*|\||n|\<nobracket\>>><big|sum><rsub|a*b=n>1>>|<row|<cell|>|<cell|=>|<cell|<big|sum><rsub|a*b\<leq\>x,p*q<around*|\||a*b|\<nobracket\>>>1>>|<row|<cell|>|<cell|=>|<cell|<big|sum><rsub|a*b\<leq\>x,p*q<around*|\||a|\<nobracket\>>>1+<big|sum><rsub|a*b\<leq\>x,p*q*<around*|\||b|\<nobracket\>>>1+<big|sum><rsub|a*b\<leq\>x,p*<around*|\||a,q|\|>b>1+<big|sum><rsub|a*b\<leq\>x,p*<around*|\||b,q|\|>a>1>>|<row|<cell|>|<cell|=>|<cell|P<around*|(|x;p*q|)>+2*<big|sum><rsub|a*b\<leq\>x,p*<around*|\||a,q|\|>b>1>>|<row|<cell|>|<cell|=>|<cell|P<around*|(|x;p*q|)>+2*<big|sum><rsub|a*b*p*q\<leq\>x>1>>|<row|<cell|>|<cell|=>|<cell|P<around*|(|x;p*q|)>+2*<big|sum><rsub|a*b*\<leq\>x/<around*|(|p*q|)>>1>>|<row|<cell|>|<cell|=>|<cell|P<around*|(|x;p*q|)>+2*T<around*|(|x/p*q|)>>>|<row|<cell|<big|sum><rsub|n\<leq\>x/p*q>\<tau\><around*|(|p*q*n|)>>|<cell|=>|<cell|<big|sum><rsub|n\<leq\>x/p*q><big|sum><rsub|a*b=n><big|sum><rsub|p<around*|\||n|\<nobracket\>>><big|sum><rsub|q<around*|\||n/p|\<nobracket\>>>1>>>>
  </eqnarray*>
  ...
  <\eqnarray*>
    <tformat|<table|<row|<cell|<big|sum><rsub|n\<leq\>x>\<tau\><around*|(|n<rsup|2>|)>>|<cell|=>|<cell|<big|sum><rsub|n\<leq\>x><big|sum><rsub|a<around*|\||n|\<nobracket\>>>\<tau\><around*|(|<frac|n|a>|)><big|sum><rsub|b<rsup|2><around*|\||a|\<nobracket\>>>\<mu\><around*|(|b|)>>>|<row|<cell|>|<cell|=>|<cell|<big|sum><rsub|n\<leq\>x><big|sum><rsub|a*c=n>\<tau\><around*|(|c|)>*<big|sum><rsub|b<rsup|2><around*|\||a|\<nobracket\>>>*\<mu\><around*|(|b|)>>>|<row|<cell|>|<cell|=>|<cell|<big|sum><rsub|n\<leq\>x><big|sum><rsub|d*b<rsup|2>*c=n>\<tau\><around*|(|c|)>*\<mu\><around*|(|b|)>>>|<row|<cell|>|<cell|=>|<cell|<big|sum><rsub|d*b<rsup|2>*c\<leq\>x>\<tau\><around*|(|c|)>*\<mu\><around*|(|b|)>>>|<row|<cell|>|<cell|=>|<cell|<big|sum><rsub|b\<leq\><sqrt|x>>\<mu\><around*|(|b|)>*<big|sum><rsub|d*c\<leq\>x/b<rsup|2>>\<tau\><around*|(|c|)>>>|<row|<cell|>|<cell|=>|<cell|<big|sum><rsub|b\<leq\><sqrt|x>>\<mu\><around*|(|b|)>*<big|sum><rsub|n\<leq\>x/b<rsup|2>><big|sum><rsub|d<around*|\||n|\<nobracket\>>>\<tau\><around*|(|d|)>>>|<row|<cell|>|<cell|=>|<cell|<big|sum><rsub|b\<leq\><sqrt|x>>\<mu\><around*|(|b|)>*<big|sum><rsub|n\<leq\>x/b<rsup|2>>\<tau\><rsub|3><around*|(|n|)>>>|<row|<cell|>|<cell|=>|<cell|<big|sum><rsub|a\<leq\><sqrt|x>>\<mu\><around*|(|a|)>*T<rsub|3><around*|(|<frac|x|*a<rsup|2>>|)>*<frac||>>>>>
  </eqnarray*>

  <\eqnarray*>
    <tformat|<table|<row|<cell|\<tau\><around*|(|n<rsup|2>|)>>|<cell|=>|<cell|<big|sum><rsub|d<around*|\||n|\<nobracket\>>>\<mu\><around*|(|<frac|n|d>|)>*\<tau\><rsup|2><around*|(|d|)>>>|<row|<cell|>|<cell|=>|<cell|<big|sum><rsub|d<around*|\||n|\<nobracket\>>>\<tau\><around*|(|<frac|n|d>|)>*\<mu\><rsup|2><around*|(|d|)>>>|<row|<cell|>|<cell|=>|<cell|<big|sum><rsub|d<rsup|2><around*|\||n|\<nobracket\>>>\<mu\><around*|(|d|)>*\<tau\><rsub|3><around*|(|<frac|n|d<rsup|2>>|)>>>>>
  </eqnarray*>
  ...
  <\eqnarray*>
    <tformat|<table|<row|<cell|S<rsub|><around*|(|x;p,a,q,b|)>>|<cell|=>|<cell|<big|sum><rsub|n\<leq\>x/c>\<tau\><around*|(|p<rsup|a>*q<rsup|b>*n|)>>>|<row|<cell|>|<cell|=>|<cell|<around*|(|a+1|)>*<around*|(|b+1|)>*T<around*|(|<frac|x|p<rsup|a>*q<rsup|b>>|)>>>|<row|<cell|>|<cell|->|<cell|a*<around*|(|b+1|)>*T<around*|(|<frac|x|p<rsup|a+1>*q<rsup|b>>|)>>>|<row|<cell|>|<cell|->|<cell|<around*|(|a+1|)>*b*T<around*|(|<frac|x|p<rsup|a>*q<rsup|b+1>>|)>>>|<row|<cell|>|<cell|+>|<cell|a*b*T<around*|(|<frac|x|p<rsup|a+1>*q<rsup|b+1>>|)><with|font-series|bold|><space|1em><around*|(|verified|)>>>>>
  </eqnarray*>
