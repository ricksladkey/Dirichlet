...
<\body>
  ...
  <\equation*>
    ...
    n=m<rsup|k>>>|<row|<cell|0>|<cell|otherwise>>>>>>|<cell|1-x<rsup|k>>>|<row|<cell|\<tau\><around*|(|n<rsup|3>|)>>|<cell|>|<cell|<frac|1+2*x|<around*|(|1-x|)><rsup|2>>>>>>>
  </equation*>
  ...
  <\eqnarray*>
    ...
    \<geq\>30|)>>>|<row|<cell|<big|sum><rsub|n\<leq\>x,gcd<around*|(|n,5!|)>=1>M<around*|(|<frac|x|n>|)>>|<cell|=>|<cell|0<space|1em><around*|(|x\<geq\>30|)>>>>>
  </eqnarray*>
  ...
  Adapt Deliglese and Rivat algorithm for odd-only method.

  <\eqnarray*>
    <tformat|<cwith|19|19|1|-1|cell-background|pastel
    cyan>|<table|<row|<cell|<big|sum><rsub|m\<leq\>u>\<mu\><around*|(|m|)>*<big|sum><rsub|n\<leq\>x/m,n
    ...
    even>\<mu\><around*|(|m|)>*<big|sum><rsub|n\<leq\>u/m,n
    odd>M<around*|(|<frac|x/m|n>|)>>|<cell|=>|<cell|<big|sum><rsub|m\<leq\>u/2>\<mu\><around*|(|2*m|)>*<big|sum><rsub|n\<leq\>u/<around*|(|2*m|)>,n
    ...
    odd>M<around*|(|<frac|<around*|(|x/2|)>/m|n>|)>>>|<row|<cell|>|<cell|=>|<cell|-M<around*|(|<frac|x|2>|)>+M<around*|(|<frac|x|4>|)>+M<around*|(|<frac|x|4>|)>-M<around*|(|<frac|x|8>|)>-\<ldots\>>>|<row|<cell|>|<cell|=>|<cell|<choice|<tformat|<table|<row|<cell|0>|<cell|if
    u \<less\>2>>|<row|<cell|-M<around*|(|<frac|x|2>|)>>|<cell|otherwise>>>>><space|1em><around*|(|verified|)>>>|<row|<cell|<big|sum><rsub|m\<leq\>u,m
    odd>\<mu\><around*|(|m|)>*<big|sum><rsub|n\<leq\>u/m,n
    odd>M<around*|(|<frac|x/m|n>|)>>|<cell|=>|<cell|M<around*|(|x|)>-M<around*|(|<frac|x|2>|)>-M<around*|(|<frac|x|2>|)>+M<around*|(|<frac|x|4>|)>+\<ldots\>>>|<row|<cell|>|<cell|=>|<cell|M<around*|(|x|)><space|1em><around*|(|verified|)>>>|<row|<cell|<big|sum><rsub|m\<leq\>u,m
  ...
  <\eqnarray*>
    <tformat|<table|<row|<cell|<big|sum><rsub|m\<leq\>u,m
    odd>\<mu\><around*|(|m|)>*<big|sum><rsub|n\<leq\>u/m,n
    odd>M<rsub|><around*|(|<frac|x/m|n>|)>>|<cell|=>|<cell|<big|sum><rsub|l\<leq\>u,l
    odd>M<around*|(|<frac|x|l>|)>*<big|sum><rsub|m<around*|\||l|\<nobracket\>>>\<mu\><around*|(|m|)>>>|<row|<cell|>|<cell|=>|<cell|1\<cdot\>M<around*|(|<frac|x|1>|)>+<big|sum><rsub|l\<leq\>u,l
    odd>M<around*|(|<frac|x|l>|)>\<cdot\>0>>|<row|<cell|>|<cell|=>|<cell|M<around*|(|x|)>>>|<row|<cell|<big|sum><rsub|m\<leq\>u,m
    odd>\<mu\><around*|(|m|)>*<big|sum><rsub|n\<leq\>u/m,n
    odd>M<rsub|odd><rsub|><around*|(|<frac|x/m|n>|)>>|<cell|=>|<cell|<big|sum><rsub|l\<leq\>u,l
    odd>M<rsub|odd><around*|(|<frac|x|l>|)>*<big|sum><rsub|m<around*|\||l|\<nobracket\>>>\<mu\><around*|(|m|)>>>|<row|<cell|>|<cell|=>|<cell|M<rsub|odd><around*|(|x|)>>>|<row|<cell|<big|sum><rsub|m\<leq\>u,m
    odd>\<mu\><around*|(|m|)>*<big|sum><rsub|n\<leq\>x/m,n
    odd>M<rsub|odd><around*|(|<frac|x/m|n>|)>>|<cell|=>|<cell|<big|sum><rsub|m\<leq\>u,m
    odd>\<mu\><around*|(|m|)>\<cdot\>1>>|<row|<cell|>|<cell|=>|<cell|M<rsub|odd><around*|(|u|)>>>|<row|<cell|<big|sum><rsub|m\<leq\>u>\<mu\><around*|(|m|)>*<big|sum><rsub|n\<leq\>u/m,n
    odd>M<rsub|odd><around*|(|<frac|x/m|n>|)>>|<cell|=>|<cell|<big|sum><rsub|m\<leq\>u>\<mu\><around*|(|m|)>*<big|sum><rsub|n\<leq\>u/m>M<rsub|odd><around*|(|<frac|x/m|n>|)>>>|<row|<cell|>|<cell|->|<cell|<big|sum><rsub|m\<leq\>u>\<mu\><around*|(|m|)>*<big|sum><rsub|n\<leq\>u/m,n
    even>M<rsub|odd><around*|(|<frac|x/m|n>|)>>>|<row|<cell|>|<cell|=>|<cell|M<rsub|odd><around*|(|x|)>-M<rsub|odd><around*|(|<frac|x|2>|)>>>|<row|<cell|>|<cell|=>|<cell|M<around*|(|x|)>>>|<row|<cell|<big|sum><rsub|m\<leq\>u>\<mu\><around*|(|m|)>*<big|sum><rsub|n\<leq\>x/m,n
    odd>M<rsub|odd><around*|(|<frac|x/m|n>|)>>|<cell|=>|<cell|<big|sum><rsub|m\<leq\>u>\<mu\><around*|(|m|)>\<cdot\>1>>|<row|<cell|>|<cell|=>|<cell|M<around*|(|u|)>>>>>
  </eqnarray*>
  ...
  <\eqnarray*>
    <tformat|<table|<row|<cell|<big|sum><rsub|m\<leq\>u,2\<nmid\>m,3<around*|\||m|\<nobracket\>>>\<mu\><around*|(|m|)>*<big|sum><rsub|n\<leq\>u/m,n
    odd>M<around*|(|<frac|x/m|n>|)>>|<cell|=>|<cell|<big|sum><rsub|m\<leq\>u,2\<nmid\>m,3<around*|\||m|\<nobracket\>>>\<mu\><around*|(|m|)>*F<around*|(|<frac|x|m>;<frac|u|m>|)>>>|<row|<cell|>|<cell|=>|<cell|<big|sum><rsub|m\<leq\>u,2\<nmid\>m,3<around*|\||m|\<nobracket\>>>\<mu\><around*|(|m|)>*F<rsub|m>>>|<row|<cell|>|<cell|=>|<cell|\<mu\><around*|(|3|)>*F<rsub|3>+\<mu\><around*|(|9|)>*F<rsub|9>+\<mu\><around*|(|15|)>*F<rsub|15>+\<ldots\>>>|<row|<cell|>|<cell|=>|<cell|-<around*|(|\<mu\><around*|(|1|)>*F<rsub|3>+\<mu\><around*|(|3|)>*F<rsub|9>+\<mu\><around*|(|5|)>*F<rsub|15>+\<ldots\>|)>>>|<row|<cell|>|<cell|+>|<cell|<around*|(|\<mu\><around*|(|3|)>*F<rsub|9>+\<mu\><around*|(|9|)>F<rsub|27>+\<mu\><around*|(|15|)>*F<rsub|45>+\<ldots\>|)>>>|<row|<cell|>|<cell|=>|<cell|-<big|sum><rsub|m\<leq\>u/3,m
    odd>\<mu\><around*|(|m|)>*F<rsub|3*m>>>|<row|<cell|>|<cell|+>|<cell|<big|sum><rsub|m\<leq\>u/3,2\<nmid\>m,3<around*|\||m|\<nobracket\>>>\<mu\><around*|(|m|)>*F<rsub|3*m>>>|<row|<cell|>|<cell|=>|<cell|-M<around*|(|<frac|x|3>|)>+<big|sum><rsub|m\<leq\>u/3,2\<nmid\>m,3<around*|\||m|\<nobracket\>>>\<mu\><around*|(|m|)>*F<rsub|3*m>>>|<row|<cell|>|<cell|=>|<cell|-<big|sum><rsub|3<rsup|k>\<leq\>u>M<around*|(|<frac|x|3<rsup|k>>|)><space|1em><around*|(|verified|)>>>>>
  </eqnarray*>

  <\eqnarray*>
    <tformat|<table|<row|<cell|<big|sum><rsub|m\<leq\>u,3<around*|\||m|\<nobracket\>>>\<mu\><around*|(|m|)>*<big|sum><rsub|n\<leq\>u/m,n
    odd>M<around*|(|<frac|x/m|n>|)>>|<cell|=>|<cell|\<mu\><around*|(|3|)>*F<rsub|3>+\<mu\><around*|(|6|)>*F<rsub|6>+\<mu\><around*|(|9|)>*F<rsub|9>+\<ldots\>>>|<row|<cell|>|<cell|=>|<cell|-<around*|(|\<mu\><around*|(|1|)>*F<rsub|3>+\<mu\><around*|(|2|)>*F<rsub|6>+\<mu\><around*|(|3|)>*F<rsub|9>+\<ldots\>|)>>>|<row|<cell|>|<cell|+>|<cell|<around*|(|\<mu\><around*|(|3|)>*F<rsub|9>+\<mu\><around*|(|6|)>*F<rsub|18>+\<mu\><around*|(|9|)>*F<rsub|27>+\<ldots\>|)>>>|<row|<cell|>|<cell|=>|<cell|-F<around*|(|<frac|x|3>|)>+F<around*|(|<frac|x|6>|)>>>|<row|<cell|>|<cell|+>|<cell|<big|sum><rsub|m\<leq\>u/3,3<around*|\||m|\<nobracket\>>>\<mu\><around*|(|m|)>*<big|sum><rsub|n\<leq\><around*|(|u/3|)>/m,n
    odd>M<around*|(|<frac|<around*|(|x/3|)>/m|n>|)>>>|<row|<cell|>|<cell|=>|<cell|-<big|sum><rsub|3<rsup|k>\<leq\>u>M<around*|(|<frac|x|3<rsup|k>>|)>+<big|sum><rsub|2\<cdot\>3<rsup|k>\<leq\>u>M<around*|(|<frac|x|2\<cdot\>3<rsup|k>>|)><space|1em><around*|(|verified|)>>>|<row|<cell|<big|sum><rsub|m\<leq\>u,6<around*|\||m|\<nobracket\>>>\<mu\><around*|(|m|)>*<big|sum><rsub|n\<leq\>u/m,n
    odd>M<around*|(|<frac|x/m|n>|)>>|<cell|=>|<cell|\<mu\><around*|(|6|)>*F<rsub|6>+\<mu\><around*|(|12|)>*F<rsub|12>+\<mu\><around*|(|18|)>*F<rsub|18>+\<ldots\>>>|<row|<cell|>|<cell|=>|<cell|<around*|(|\<mu\><around*|(|1|)>*F<rsub|6>+\<mu\><around*|(|2|)>*F<rsub|12>+\<mu\><around*|(|3|)>*F<rsub|18>+\<ldots\>|)>>>|<row|<cell|>|<cell|->|<cell|<around*|(|\<mu\><around*|(|2|)>*F<rsub|12>+\<mu\><around*|(|4|)>*F<rsub|24>+\<mu\><around*|(|6|)>*F<rsub|36>+\<ldots\>|)>>>|<row|<cell|>|<cell|->|<cell|<around*|(|\<mu\><around*|(|3|)>*F<rsub|18>+\<mu\><around*|(|6|)>*F<rsub|36><rsub|>+\<mu\><around*|(|9|)>*F<rsub|54>+\<ldots\>|)>>>|<row|<cell|>|<cell|+>|<cell|<around*|(|<around*|\<nobracket\>|\<mu\>6|)>*F<rsub|36>+\<mu\><around*|(|12|)>*F<rsub|72>+\<mu\><around*|(|18|)>*F<rsub|108>+\<ldots\>|)>>>|<row|<cell|>|<cell|=>|<cell|F<around*|(|<frac|x|6>|)>-F<around*|(|<frac|x|12>|)>>>|<row|<cell|>|<cell|+>|<cell|F<around*|(|<frac|x|12>|)>>>|<row|<cell|>|<cell|+>|<cell|F<around*|(|<frac|x|18>|)>-F<around*|(|<frac|x|36>|)>>>|<row|<cell|>|<cell|->|<cell|<big|sum><rsub|m\<leq\>u/18,3<around*|\||m|\<nobracket\>>>\<mu\><around*|(|m|)>*<big|sum><rsub|n\<leq\><around*|(|u/18|)>/m,n
    odd>M<around*|(|<frac|<around*|(|x/18|)>/m|n>|)>>>|<row|<cell|>|<cell|+>|<cell|<big|sum><rsub|m\<leq\>u/6,6<around*|\||m|\<nobracket\>>>\<mu\><around*|(|m|)>*<big|sum><rsub|n\<leq\><around*|(|u/6|)>/m,n
    odd>M<around*|(|<frac|<around*|(|x/6|)>/m|n>|)>>>|<row|<cell|>|<cell|=>|<cell|F<around*|(|<frac|x|6>|)>+F<around*|(|<frac|x|18>|)>-F<around*|(|<frac|x|36>|)>+\<ldots\>>>|<row|<cell|>|<cell|=>|<cell|<big|sum><rsub|2\<cdot\>3<rsup|k>\<leq\>u>M<around*|(|<frac|x|2\<cdot\>3<rsup|k>>|)><space|1em><around*|(|verified|)>>>>>
  </eqnarray*>

  <\eqnarray*>
    <tformat|<table|<row|<cell|M<rsub|odd><around*|(|n|)>>|<cell|=>|<cell|M<around*|(|n|)>+M<rsub|odd><around*|(|<frac|n|2>|)>>>|<row|<cell|M<around*|(|n|)>>|<cell|=>|<cell|M<rsub|odd><around*|(|n|)>-M<rsub|odd><around*|(|<frac|n|2>|)>>>>>
  </eqnarray*>

  Converting a comparison between floor or ceiling of a real number to an
  integer.

  <\eqnarray*>
    <tformat|<table|<row|<cell|n\<geq\><around*|\<lfloor\>|x|\<rfloor\>>>|<cell|\<Leftrightarrow\>>|<cell|n\<gtr\>x-1>>|<row|<cell|n\<gtr\><around*|\<lfloor\>|x|\<rfloor\>>>|<cell|\<Leftrightarrow\>>|<cell|n\<gtr\>x>>|<row|<cell|n\<leq\><around*|\<lfloor\>|x|\<rfloor\>>>|<cell|\<Leftrightarrow\>>|<cell|n\<leq\>x>>|<row|<cell|n\<less\><around*|\<lfloor\>|x|\<rfloor\>>>|<cell|\<Leftrightarrow\>>|<cell|n\<less\>x-1>>|<row|<cell|n\<geq\><around*|\<lceil\>|x|\<rceil\>>>|<cell|\<Leftrightarrow\>>|<cell|n\<geq\>x>>|<row|<cell|n\<gtr\><around*|\<lceil\>|x|\<rceil\>>>|<cell|\<Leftrightarrow\>>|<cell|n\<gtr\>x-1>>|<row|<cell|n\<leq\><around*|\<lceil\>|x|\<rceil\>>>|<cell|\<Leftrightarrow\>>|<cell|n\<less\>x+1>>|<row|<cell|n\<less\><around*|\<lceil\>|x|\<rceil\>>>|<cell|\<Leftrightarrow\>>|<cell|n\<less\>x>>>>
  </eqnarray*>

  <\eqnarray*>
    <tformat|<table|<row|<cell|x<rsub|1>>|<cell|\<gtr\>>|<cell|<around*|\<lfloor\>|<frac|<around*|\<lfloor\>|n/i|\<rfloor\>>|<around*|\<lfloor\>|<sqrt|<around*|\<lfloor\>|n/i|\<rfloor\>>>|\<rfloor\>>>|\<rfloor\>>-1>>|<row|<cell|x<rsub|1>>|<cell|\<gtr\>>|<cell|<around*|\<lceil\>|<sqrt|<around*|\<lfloor\>|n/i|\<rfloor\>>>|\<rceil\>>-1>>|<row|<cell|x<rsub|1>>|<cell|\<geq\>>|<cell|<around*|\<lceil\>|<sqrt|<around*|\<lfloor\>|n/i|\<rfloor\>>>|\<rceil\>>>>|<row|<cell|x<rsub|1>>|<cell|\<geq\>>|<cell|<sqrt|<around*|\<lfloor\>|n/i|\<rfloor\>>>>>|<row|<cell|x<rsub|1><rsup|2>>|<cell|\<geq\>>|<cell|<around*|\<lfloor\>|n/i|\<rfloor\>>>>|<row|<cell|x<rsub|1><rsup|2>>|<cell|\<gtr\>>|<cell|n/i-1>>|<row|<cell|x<rsub|1><rsup|2>+1>|<cell|\<gtr\>>|<cell|n/i>>|<row|<cell|i>|<cell|\<gtr\>>|<cell|<frac|n|x<rsub|1><rsup|2>+1>>>>>
  </eqnarray*>

  Adapt Deligese and Rivat inverted sum to odd-only method.

  <\eqnarray*>
    <tformat|<cwith|4|4|1|-1|cell-background|pastel
    cyan>|<table|<row|<cell|S<rsub|2><around*|(|n,i<rsub|max>|)>>|<cell|=>|<cell|<big|sum><rsub|k\<leq\><sqrt|n>>M<around*|(|k|)>*<big|sum><rsub|i\<leq\>min<around*|(|i<rsub|max>,n/k<rsup|2>|)>>\<mu\><around*|(|i|)>*<around*|(|<around*|\<lfloor\>|<frac|n/i|k>|\<rfloor\>>-<around*|\<lfloor\>|<frac|n/i|k+1>|\<rfloor\>>|)>>>|<row|<cell|>|<cell|=>|<cell|<big|sum><rsub|k\<leq\><sqrt|n>>M<around*|(|k|)>*<big|sum><rsub|i\<leq\>min<around*|(|i<rsub|max>,n/k<rsup|2>|)>>\<mu\><around*|(|i|)>*<around*|(|<around*|\<lfloor\>|<frac|n/k|i>|\<rfloor\>>-<around*|\<lfloor\>|<frac|n/<around*|(|k+1|)>|i>|\<rfloor\>>|)>>>|<row|<cell|S<rsub|2,odd><around*|(|n,i<rsub|max>|)>>|<cell|=>|<cell|<big|sum><rsub|i\<leq\>i<rsub|max>,i
    odd>\<mu\><around*|(|i|)>*<big|sum><rsub|<sqrt|n/i>\<less\>j\<leq\>n/i,j
  ...
  <\eqnarray*>
    <tformat|<table|<row|<cell|W<rsub|count>>|<cell|=>|<cell|#<around*|{|a:a\<less\>m,<around*|(|a,m|)>=1|}>>>|<row|<cell|T<rsup|<around*|(|m|)>><rsub|1><around*|(|n|)>>|<cell|=>|<cell|<around*|\<lfloor\>|<frac|n|m>|\<rfloor\>>*W<rsub|count>>>|<row|<cell|T<rsup|<around*|(|m|)>><rsub|2><around*|(|n|)>>|<cell|=>|<cell|<big|sum><rsub|x=1><rsup|n>T<rsup|<around*|(|m|)>><rsub|1><around*|(|x|)>>>|<row|<cell|>|<cell|=>|<cell|<big|sum><rsub|x\<less\><sqrt|n>,<around*|(|x,m|)>=1>T<rsup|<around*|(|m|)>><rsub|1><around*|(|x|)>-2<around*|[|*T<rsup|<around*|(|m|)>><rsub|1><around*|(|x|)>|]><rsup|2>>>>>
  </eqnarray*>

  <\eqnarray*>
    <tformat|<table|<row|<cell|T<rsub|3><around*|(|n|)>>|<cell|=>|<cell|<big|sum><rsub|x\<leq\>n>\<tau\><rsub|2><around*|(|x|)>*T<rsub|1><around*|(|<frac|n|x>|)>>>|<row|<cell|>|<cell|=>|<cell|<big|sum><rsub|x\<leq\>a>\<tau\><rsub|2><around*|(|x|)>*T<rsub|1><around*|(|<frac|n|x>|)>+<big|sum><rsub|y
    \<less\> n/a><around*|[|T<rsub|2><around*|(|<frac|n|y>|)>-T<rsub|2><around*|(|<frac|n|y+1>|)>|]>*T<rsub|1><around*|(|y|)>>>>>
  </eqnarray*>

  <\eqnarray*>
    <tformat|<table|<row|<cell|\<beta\><around*|(|x|)>>|<cell|=>|<cell|<around*|\<lfloor\>|n/x|\<rfloor\>>>>|<row|<cell|\<delta\><rsub|1><around*|(|x|)>>|<cell|=>|<cell|\<beta\><around*|(|x|)>-\<beta\><around*|(|x+2|)>>>|<row|<cell|\<delta\><rsub|2><around*|(|x|)>>|<cell|=>|<cell|\<delta\><rsub|1><around*|(|x|)>-\<delta\><rsub|1><around*|(|*x+2|)>>>|<row|<cell|\<delta\><rsub|3><around*|(|x|)>>|<cell|=>|<cell|\<delta\><rsub|2><around*|(|x|)>-\<delta\><rsub|2><around*|(|x+2|)>>>|<row|<cell|\<varepsilon\><around*|(|x|)>>|<cell|=>|<cell|n-x*\<beta\><around*|(|x|)>>>|<row|<cell|\<varepsilon\><around*|(|x|)>-\<varepsilon\><around*|(|x+2|)>>|<cell|=>|<cell|<around*|(|x+2|)>*\<beta\><around*|(|x+2|)>-x*\<beta\><around*|(|x|)>>>|<row|<cell|>|<cell|=>|<cell|<around*|(|x+2|)>*\<beta\><around*|(|x+2|)>-x<around*|(|\<beta\><around*|(|x+2|)>+\<delta\><rsub|1><around*|(|x+2|)>+\<delta\><rsub|2><around*|(|x+2|)>+\<delta\><rsub|3><around*|(|x|)>|)>*>>|<row|<cell|>|<cell|=>|<cell|2*\<beta\><around*|(|x+2|)>-x*<around*|(|\<delta\><rsub|1><around*|(|x+2|)>+\<delta\><rsub|2><around*|(|x+2|)>|)>-x*\<delta\><rsub|3><around*|(|x|)>>>|<row|<cell|\<alpha\><around*|(|x|)>>|<cell|=>|<cell|<around*|(|x-2|)>*\<delta\><rsub|2><around*|(|x|)>>>|<row|<cell|\<gamma\><around*|(|x|)>>|<cell|=>|<cell|2*\<beta\><around*|(|x|)>-<around*|(|*x-2|)>*\<delta\><rsub|1><around*|(|x|)>>>|<row|<cell|\<gamma\><around*|(|x|)>-\<gamma\><around*|(|x+2|)>>|<cell|=>|<cell|2*\<beta\><around*|(|x|)>-<around*|(|*x-2|)>*\<delta\><rsub|1><around*|(|x|)>-<around*|(|2*\<beta\><around*|(|x+2|)>-x*\<delta\><rsub|1><around*|(|x+2|)>|)>>>|<row|<cell|>|<cell|=>|<cell|2*<around*|(|\<beta\><around*|(|x|)>-\<beta\><around*|(|x+2|)>|)>-<around*|(|x-2|)>*\<delta\><rsub|1><around*|(|x|)>+x<around*|(|*\<delta\><rsub|1><around*|(|x|)>-\<delta\><rsub|2><around*|(|x|)>|)>>>|<row|<cell|>|<cell|=>|<cell|4*\<delta\><rsub|1><around*|(|x|)>+2*\<delta\><rsub|2><around*|(|x|)>-\<alpha\><around*|(|x|)>>>|<row|<cell|\<alpha\><around*|(|x|)>-\<alpha\><around*|(|x+1|)>>|<cell|=>|<cell|<around*|(|x-2|)>*\<delta\><rsub|2><around*|(|x|)>-x*\<delta\><rsub|2><around*|(|x+2|)>>>|<row|<cell|>|<cell|=>|<cell|<around*|(|x-2|)>*\<delta\><rsub|2><around*|(|x|)>-x*<around*|(|\<delta\><rsub|2><around*|(|x|)>-\<delta\><rsub|3><around*|(|x|)>|)>>>|<row|<cell|>|<cell|=>|<cell|-2*\<delta\><rsub|2><around*|(|x|)>+x*\<delta\><rsub|3><around*|(|x|)>>>|<row|<cell|<wide|\<varepsilon\>|^><around*|(|x|)>>|<cell|=>|<cell|\<varepsilon\><around*|(|x+2|)>+\<gamma\><around*|(|x+2|)>-\<alpha\><around*|(|x+2|)>>>|<row|<cell|\<delta\><rsub|3><around*|(|x|)>>|<cell|=>|<cell|<around*|\<lfloor\>|<frac|<wide|\<varepsilon\>|^><around*|(|x|)>|x>|\<rfloor\>>>>|<row|<cell|\<delta\><rsub|2><around*|(|x|)>>|<cell|=>|<cell|\<delta\><rsub|2><around*|(|x+2|)>+\<delta\><rsub|3><around*|(|x|)>>>|<row|<cell|\<delta\><rsub|1><around*|(|x|)>>|<cell|=>|<cell|\<delta\><rsub|1><around*|(|x+2|)>+\<delta\><rsub|2><around*|(|x|)>>>|<row|<cell|\<varepsilon\><around*|(|x|)>>|<cell|=>|<cell|<wide|\<varepsilon\>|^><around*|(|x|)>-x*\<delta\><rsub|3><around*|(|x|)>>>|<row|<cell|\<alpha\><around*|(|x|)>>|<cell|=>|<cell|\<alpha\><around*|(|x+2|)>-2*\<delta\><rsub|2><around*|(|x|)>+x*\<delta\><rsub|3><around*|(|x|)>>>|<row|<cell|\<gamma\><around*|(|x|)>>|<cell|=>|<cell|\<gamma\><around*|(|x+2|)>+4*\<delta\><rsub|1><around*|(|x|)>+2*\<delta\><rsub|2><around*|(|x|)>-\<alpha\><around*|(|x|)>>>|<row|<cell|\<beta\><around*|(|x|)>>|<cell|=>|<cell|\<beta\><around*|(|x+2|)>+\<delta\><rsub|1><around*|(|x|)>>>>>
  </eqnarray*>
  ...
  <\eqnarray*>
    <tformat|<table|<row|<cell|\<varphi\><around*|(|n|)>>|<cell|=>|<cell|<big|sum><rsub|1\<leq\>i\<leq\>n,gcd<around*|(|i,n|)>=1>1>>|<row|<cell|\<varphi\><around*|(|n;a|)>>|<cell|=>|<cell|<big|sum><rsub|1\<leq\>i\<leq\>a,gcd<around*|(|i,n|)>=1>1>>|<row|<cell|>|<cell|=>|<cell|>>>>
  </eqnarray*>
</body>
