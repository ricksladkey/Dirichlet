...
namespace Decompose.Numerics
{
    public sealed class UInt32Operations : IOperations<uint>
    {
        ...
        public uint MinValue { get { return uint.MinValue; } }
        public uint MaxValue { get { return uint.MaxValue; } }
        ...
        public int Sign(uint a) { return a != 0 ? 1 : 0; }
        ...
        public uint AbsoluteValue(uint a) { return a; }
        public Complex Log(uint a) { return Math.Log(a); }
        public uint Factorial(uint a) { return IntegerMath.Factorial(a); }
    }
}
