...
namespace Decompose.Numerics
{
    public sealed class Int32Operations : IOperations<int>
    {
        ...
        public int Convert(double a) { return (int)a; }
        ...
        public int Modulo(int a, int b) { var result = a % b; if (result < 0) result += b; return result; }
        ...
        public int ModularQuotient(int a, int b, int modulus) { return IntegerMath.ModularQuotient(a, b, modulus); }
        ...
        public Complex Log(int a) { return Math.Log(a); }
        public int Factorial(int a) { return IntegerMath.Factorial(a); }
    }
}
